...
namespace Chubbyphp\Api\Collection;
...
abstract class AbstractCollection implements CollectionInterface
{
    ...
    /**
     * @return array{offset: int, limit: int, filters: array<string, null|string>, sort: array<string, null|string>, items: array<array{id: string, createdAt: \DateTimeInterface, updatedAt: null|\DateTimeInterface, ...}>, count: int}
     */
